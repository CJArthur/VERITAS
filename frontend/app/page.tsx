        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-stone-200">
            {[
              ...
              {
                icon: RefreshCw,
                title: "Двойная верификация организаций",
                desc: "Каждая организация проходит два независимых барьера: алгоритм ФНС проверяет математическую корректность регистрационных данных, затем сотрудник платформы подтверждает подлинность через публичные реестры и личный контакт с организацией. Ни одна фиктивная структура не проходит.",
              },
              {
                icon: Lock,
                title: "Нетронутый аудит-журнал",
                desc: "История каждой проверки защищена на уровне базы данных — изменить или удалить запись физически невозможно даже при полной компрометации приложения. Полный след для любого аудита.",
              },
              {
                icon: ShieldCheck,
                title: "Математически невозможно подделать",
                desc: "Каждый документ защищён криптографической подписью организации. Даже если злоумышленник получит доступ к базе данных и изменит содержимое — подпись немедленно станет недействительной. Подделать незаметно невозможно.",
              },
            ].map((f) => (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              { law: "ФЗ-63", desc: "Электронная подпись обеспечивает юридически значимое подтверждение подлинности каждого документа" },
            ].map((l) => (
      ...
      <section className="bg-[#1c1917] px-4 py-16 sm:py-20">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-stone-600 text-xs mb-10">
            Подайте заявку — данные организации пройдут двойную проверку перед активацией доступа.
          </p>
